...
class CaptionEvaluator:
    ...
    def load_gt(self):
        ...
        pairs = {}
        with open(self.ground_truth_path,encoding="utf-8") as csvfile:
            
            # Check if the delimiter is a pipe or tab
    ...
    def load_predictions(self, submission_file_path):
        ...
        with open(submission_file_path,encoding="utf-8") as csvfile:
            # Check if the delimiter is a pipe or tab
            sample = csvfile.readline()
            if '|' in sample:
                delimiter = '|' 
            ...
            print(len(occured_images),len(image_ids_gt))
...
if __name__ == "__main__":
    ...
    ground_truth_path = "labels.csv"

    submission_file_path = "taskA_7809_run1.csv"
